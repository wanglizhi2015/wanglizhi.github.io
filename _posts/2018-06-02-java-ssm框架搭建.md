...
#### 13、main\java\entity目录下添加Test.java文件
```java
package entity;
...
#### 14、main\java\mapper目录下添加TestMapper.java接口
```java
package mapper;
import entity.Test;
...
#### 15、main\java\service目录下添加TestService.java文件
```java
package service;
import entity.Test;
...
#### 16、main\java\controller目录下添加TestController.java文件
```java
package controller;
import entity.Test;
import org.springframework.beans.factory.annotation.Autowired;
